...
def enviar_correo(contexto=None):
    ...
    if connection:
        try:
            ...
            print(f"Error al ejecutar la función enviar_correo: {e}")
    else:
...
#             fecha_envio_correo = datetime(fecha_envio_correo.year, fecha_envio_correo.month, fecha_envio_correo.day, 11, 53, 0)
